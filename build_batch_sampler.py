...
from espnet2.samplers.num_elements_batch_sampler import NumElementsBatchSampler,NumElementsBatchSampler_category
...
def build_batch_sampler(
    ...
    elif type == "numel_category": #new numel category
        retval = NumElementsBatchSampler_category(
            batch_bins=batch_bins,
            shape_files=shape_files,
            sort_in_batch=sort_in_batch,
            sort_batch=sort_batch,
