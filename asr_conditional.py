...
from espnet2.asr.espnet_model_con import ESPnetASRModel
...
encoder_rec_choices = ClassChoices(
    "encoder_rec",
    classes=dict(
        conformer=ConformerEncoder,
        transformer=TransformerEncoder,
...
encoder_con_choices = ClassChoices(
    "encoder_con",
    classes=dict(
        conformer=ConformerEncoder,
        transformer=TransformerEncoder,
...
class ASRTask(AbsTask):
    ...
    class_choices_list = [
        ...
        encoder_choices,
        # --encoder_rec and --encoder_rec_conf
        encoder_rec_choices,
        # --encoder_con and --encoder_con_conf
        encoder_con_choices,
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        encoder_con_class = encoder_con_choices.get_class(args.encoder_con)
        encoder_con = encoder_con_class(eprojs=encoder.output_size(), **args.encoder_con_conf)
        

        encoder_rec_class = encoder_rec_choices.get_class(args.encoder_rec)
        encoder_rec = encoder_rec_class(input_size=encoder_con.output_size(), **args.encoder_rec_conf)
        
        #pdb.set_trace()

        # 6. CTC
        ctc = CTC(
            odim=vocab_size, encoder_output_sizse=encoder_rec.output_size(),reduce = False, **args.ctc_conf
        )
        ...
        model = ESPnetASRModel(
            ...
            encoder=encoder,
            encoder_con=encoder_con,
            encoder_rec=encoder_rec,
            ctc=ctc,
